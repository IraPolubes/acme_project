...
def calculate_birthday_countdown(birthday):
    ...
    in the context of the calculate_birthday_countdown and get_birthday_for_year functions in birthday/utils.py,
    birthday is simply a variable name for the argument passed into the function
